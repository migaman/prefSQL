...
namespace prefSQL.SQLParserTest
{
    ...
    public class SQLParserSkylineTest
    {
        ...
        public void TestSKYLINEAmountOfTupels_MSSQLCLR()
        {
            ...
            var cnnSQL = new SqlConnection(strConnection);
        ...
        public void TestSKYLINEAmountOfTupels_DataTable()
        {
            ...
            common.SkylineType = new SkylineBNL();
            DataTable dtBNL = common.parseAndExecutePrefSQL(strConnection, driver, skylineSampleSql);
            common.SkylineType = new SkylineBNLSort();
            DataTable dtBNLSort = common.parseAndExecutePrefSQL(strConnection, driver, skylineSampleSql);
            ...
            {
                common.SkylineType = new SkylineDQ();
                dtDQ = common.parseAndExecutePrefSQL(strConnection, driver, skylineSampleSql);
            }
