        ...
        public void Run()
        {
            try
            {
                ...
                */
                ...
                strPrefSQL = "SELECT TOP 5 t1.id AS ID, t1.title, t1.price FROM cars_small t1 SKYLINE OF t1.price HIGH, t1.title ('MERCEDES-BENZ SL 500' >> OTHERS EQUAL) ORDER BY BEST_RANK()";
