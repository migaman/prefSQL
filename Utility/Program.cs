        ...
        public void Run()
        {
            try
            {
                ...
                */
                ...
                string strPrefSQL = "SELECT t1.id, t1.title, t1.price, colors.name FROM cars_small t1 " +
                    ...
                    "SKYLINE OF t1.price LOW, colors.name ('blau' >> OTHERS EQUAL)";
                ...
                strPrefSQL = "SELECT TOP 5 c.id AS ID, c.title AS Name " +
                    "FROM Cars_small c " +
